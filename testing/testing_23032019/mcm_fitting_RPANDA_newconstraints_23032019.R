load('~/MVMC/testing/testing_23032019/tree_list (MC).RData')
load('~/MVMC/testing/testing_23032019/MC_S_matrices.RData')
load('~/MVMC/testing/testing_23032019/MC_sig2_values.RData')
load('~/MVMC/testing/testing_23032019/MC_sim_tree_20_sig2_2_half_life_2_pars_2.RData')
...
source('~/MVMC/R/createModel_MC_MV_constrained.R', chdir = TRUE)
...
for(i in 2:20){ #for 20 trees
	...
	for(j in 2:2){ #for 3 sig2 matrices
		...
		mcm<-createModel_MC_MV_BETA(tree)
		...
		##pars list [[j]][[2]]
		int<-c(i,20,sig2.matrices[[j]][1,1],sig2.matrices[[j]][2,2],sig2.matrices[[j]][2,1],0,0,pars.list[[j]][[k]][1,1],pars.list[[j]][[k]][2,2],pars.list[[j]][[k]][1,2],pars.list[[j]][[k]][2,1],mcm.sig2_1,mcm.sig2_2,mcm.sig2_cov,mcm.m0_1,mcm.m0_2,mcm.S_1,mcm.S_2,mcm.S_12cov,mcm.S_21cov,-mcm.fit$value, mcm.fit$convergence,bmm.sig2_1,bmm.sig2_2,bmm.sig2_cov,bmm.m0_1,bmm.m0_2,bmm.fit$LogLik, bmm.fit$convergence,oum.sig2_1,oum.sig2_2,oum.sig2_cov,oum.m0_1,oum.m0_2,oum.alpha_1,oum.alpha_2,oum.alpha_cov,oum.fit$LogLik, oum.fit$convergence)
		
		res.mat[counter,]<-int
		print(int)
		write.csv(res.mat,file="~/Dropbox/mcm_rpanda_fits_int_23032019_NOconstraints_1cov_BMstart.csv")
		counter=counter+1
		}
