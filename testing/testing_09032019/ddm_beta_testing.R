load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_1_tip_sig2_1.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_1_tip_sig2_2.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_2_tip_sig2_1.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_2_tip_sig2_2.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_3_tip_sig2_1.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_3_tip_sig2_2.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_4_tip_sig2_1.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_4_tip_sig2_2.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_5_tip_sig2_1.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_5_tip_sig2_2.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_6_tip_sig2_1.RData')
load('~/MVMC/testing/testing_07032019/DDexp_neg_sim_tree_50_root_sig2_6_tip_sig2_2.RData')

load('~/MVMC/testing/testing_07032019/DDexp_r_term_matrices.RData')
load('~/MVMC/testing/testing_07032019/DDexp_root_sig2_values.RData')
load('~/MVMC/testing/testing_07032019/DDexp_tip_sig2_values.RData')
load('~/MVMC/testing/testing_07032019/tree_list.RData')
...
counter=1
for(i in 1:10){ #for 5 trees

	for(j in 1:6){ #for 3 sig2 matrices
	
		for(k in 1:2){ #for 3 slope matrices
		...
		int<-c(i,50,sig2.matrices[[j]][1,1],sig2.matrices[[j]][2,2],sig2.matrices[[j]][2,1],0,0,pars.list[[1]][[j]][[k]][1,1],pars.list[[1]][[j]][[k]][2,2],pars.list[[1]][[j]][[k]][1,2],ddm.sig2_1,ddm.sig2_2,ddm.sig2_cov,ddm.m0_1,ddm.m0_2,ddm.r_1,ddm.r_2,ddm.r_cov,-ddm.fit$value, ddm.fit$convergence,bmm.sig2_1,bmm.sig2_2,bmm.sig2_cov,bmm.m0_1,bmm.m0_2,bmm.fit$LogLik, bmm.fit$convergence)
		
		res.mat[counter,]<-int
		print(int)
		write.csv(res.mat,file="~/Dropbox/ddm_rpanda_fits_beta_int_08032019.csv")
		counter=counter+1
		}
