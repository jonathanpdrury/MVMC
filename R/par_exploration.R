...
#sig2_0=0.1, positive slope (same thing as switching starting and endrate)
sim_t_comp_plot(tree_020,c(1,0.1151293),0,model="DDexp",plot=TRUE)

#sig2_0=0.5, positive slope (same thing as switching starting and endrate)
sim_t_comp_plot(tree_020,c(1,0.1956012),0,model="DDexp",plot=TRUE)

#sig2_0=1.0, positive slope (same thing as switching starting and endrate)
sim_t_comp_plot(tree_020,c(1,0.2302585),0,model="DDexp",plot=TRUE)
